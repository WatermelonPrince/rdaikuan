...
//        let openTimes = CommonUtil.getStorageVariable(forKey: "save_openAppTimes");
//        if (openTimes == nil) {
////            欢迎页
//            self.window?.rootViewController = CommonGuideViewController();
//            //默认开启摇一摇
//            LotteryUtil.saveIsEnabledShakeAction(isOn: true);
//
//        } else {
            //开屏广告
//            LaunchAdService().getAd();
...
//        }
        ...
        // [ GTSdk ]：自定义渠道
        GeTuiSdk.setChannelId("APPStorer");
    ...
    {
        // 设置导航栏默认的背景颜色
        UIColor.defaultNavBarBarTintColor = COLOR_BLUE!
        // 设置导航栏所有按钮的默认颜色
