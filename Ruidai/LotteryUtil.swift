...
//    //获取某个product的咨询聊天记录
//    static func IMHistoryList(productId: String) -> Array<NSAttributedString>? {
//        let jsonString = CommonUtil.getStorageVariable(forKey: "IMHistoryList_\(productId)") as? Array<NSAttributedString>;
//
//        return jsonString;
//    }
//    static func saveIMHistoryList(IMList: Array<NSAttributedString>,productId: String) {
//        let jsonString = IMList.toJSONString();
//        CommonUtil.setStorageVariable(jsonString, forKey: "save_homeEntranceList");
//
//    }
