...
//    var luckList : Array<String>?;
    ...
    override func viewDidLoad() {
        ...
        self.webView = WKWebView(frame: CGRect.init(x: self.view.frame.origin.x, y: self.view.frame.origin.y, width: self.view.frame.size.width, height: self.view.frame.size.height - FOOTERSAFEHEIGHT), configuration: configuration);
