...
class CommonUtil: NSObject {
    ...
    static func toServerParameterString(IndexArray: Array<Int>) -> String {
        var parameterString = "";
        ...
        for number in IndexArray.enumerated() {
            parameterString.append("\(number.element)");
            if (number.offset != IndexArray.count-1) {
