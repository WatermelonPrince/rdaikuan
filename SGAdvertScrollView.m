...
- (UILabel *)tipsLabel {
    if (!_tipsLabel) {
        ...
        _tipsLabel.frame = CGRectMake(self.iconImage.frame.size.width + 15, 0, self.frame.size.width - 35 - self.iconImage.frame.size.width, self.frame.size.height);
...
- (UIImageView *)iconImage{
    if (!_iconImage) {
        ...
        _iconImage.frame = CGRectMake(0, 7, 35, 35);
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell.iconImage sd_setImageWithURL:[NSURL URLWithString:self.imageDataArr[indexPath.item]]];
//    cell.iconImage.image = [UIImage imageNamed:@"icon_avatar"];
    return cell;
}
